# util-linux 2.12r		[ since v2.12r, c.2005-11-29 ]
# last mod WmT, 2011-02-16	[ (c) and GPLv2 1999-2011 ]
...
URLS+=http://www.mirrorservice.org/sites/ftp.kernel.org/pub/linux/utils/util-linux/v2.12/util-linux-${UTILLX_VER}.tar.bz2
...
${XDC_ROOT}/sbin/fdisk: ${TOPLEV}/${UTILLX_EGPNAME}.egp
	mkdir -p ${XDC_ROOT}
	STRIP=${TARGET_SPEC}-strip ${PCREATE_SCRIPT} install ${XDC_ROOT} ${TOPLEV}/${UTILLX_EGPNAME}.egp

REALCLEAN_TARGETS+= ${TOPLEV}/${UTILLX_EGPNAME}.egp
