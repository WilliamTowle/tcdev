# gzip 1.4			[ since 1.2.4a, c.2005-11-29 ]
...
#${EXTTEMP}/${GZIP_PATH}-htc/.built: ${EXTTEMP}/${GZIP_PATH}-htc/.configured
#	( cd ${EXTTEMP}/${GZIP_PATH}-htc || exit 1 ;\
#		make || exit 1 \
#	) || exit 1
...
${XDC_ROOT}/usr/bin/gzip: ${TOPLEV}/${GZIP_EGPNAME}.egp
	${PCREATE_SCRIPT} install ${XDC_ROOT} ${TOPLEV}/${GZIP_EGPNAME}.egp
...
#.PHONY: htc-gzip
#htc-gzip: ${EXTTEMP}/${GZIP_PATH}-htc/.built
