# uClibc-rt 0.9.30.1		[ since 0.9.20 ]
...
ifeq (${UCLIBC_RT_VER},0.9.30.1)
UCLIBC_RT_SRC+=${SOURCEROOT}/u/uClibc-0.9.30.1-patches-1.0.tar.bz2
URLS+=http://www.mirrorservice.org/sites/www.ibiblio.org/gentoo/distfiles/uClibc-0.9.30.1-patches-1.0.tar.bz2
endif
...
${UCLIBC_RT_INSTTEMP}/lib/libc.so.0: ${EXTTEMP}/uClibc-rt-${UCLIBC_RT_VER}-xdc/lib/libc.a
