# patch 2.6.1			[ since v2.5.4, c. 2008-02-10 ]
# last mod WmT, 2010-01-11	[ (c) and GPLv2 1999-2010 ]
...
SOURCES:=
SOURCES+=${SOURCEROOT}/p/patch-${PATCH_VER}.tar.bz2
...
${XDC_ROOT}/usr/bin/patch: ${TOPLEV}/${PATCH_EGPNAME}.egp
	mkdir -p ${XDC_ROOT}
	${PCREATE_SCRIPT} install ${XDC_ROOT} ${TOPLEV}/${PATCH_EGPNAME}.egp

REALCLEAN_TARGETS+= ${XDC_ROOT} ${TOPLEV}/${PATCH_EGPNAME}.egp
