...
include Config/busybox/v1.6.1.mak
include Config/bzip2/v1.0.4-eg0.9.3.mak
include Config/cross-binutils/v2.17-lch0.9.3.mak
include Config/cross-gcc/v4.1.2.mak
include	Config/findutils/v4.2.29-eg0.9.3.mak
include	Config/gzip/v1.3.12.mak
include Config/host-binutils/v2.17-lch0.9.3.mak
include Config/host-gcc/v4.1.2.mak
include Config/kgcc/v4.1.2.mak
include Config/lxheaders/v2.6.20.1-lch0.9.3.mak
include Config/lxsource/v2.6.20.1-lch0.9.2.mak
...
include Config/uClibc-dev/v0.9.28.3-2.mak
include Config/uClibc-rt/v0.9.28.3-2.mak
