...
#UCLIBC_RT_SRC+=${SOURCEROOT}/u/uClibc-0.9.28.1-patches-1.0.tar.bz2
...
${EXTTEMP}/${UCLIBC_RT_PATH}/Makefile:
	...
	( cd ${EXTTEMP}/${UCLIBC_RT_PATH} || exit 1 ;\
...
${EXTTEMP}/uClibc-rt-${UCLIBC_RT_VER}-xdc/lib/libc.a:
	${MAKE} ${EXTTEMP}/${UCLIBC_RT_PATH}/Makefile
	[ ! -d ${EXTTEMP}/uClibc-rt-${UCLIBC_RT_VER}-xdc ] || rm -rf ${EXTTEMP}/uClibc-rt-${UCLIBC_RT_VER}-xdc
	mv ${EXTTEMP}/${UCLIBC_RT_PATH} ${EXTTEMP}/uClibc-rt-${UCLIBC_RT_VER}-xdc
...
xdc-uClibd-rt: ${TOPLEV}/uClibc-rt-${UCLIBC_RT_VER}.egp
endif
