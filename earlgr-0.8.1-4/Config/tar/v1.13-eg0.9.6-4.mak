# tar 1.13			[ since v1.13, c. 2008-02-10 ]
...
${XDC_ROOT}/bin/tar: ${TOPLEV}/${TAR_EGPNAME}.egp
	mkdir -p ${XDC_ROOT}
	STRIP=${TARGET_SPEC}-strip ${PCREATE_SCRIPT} install ${XDC_ROOT} ${TOPLEV}/${TAR_EGPNAME}.egp

REALCLEAN_TARGETS+= ${TOPLEV}/${TAR_EGPNAME}.egp
