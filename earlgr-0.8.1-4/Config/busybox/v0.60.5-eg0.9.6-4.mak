# busybox 0.60.5		[ since 0.60.5, c. 2006-06-17 ]
...
BUSYBOX_SRC:=
BUSYBOX_SRC+=${SOURCEROOT}/b/busybox-${BUSYBOX_VER}.tar.gz
...
BUSYBOX_EGPNAME:=busybox-${BUSYBOX_VER}

URLS+=http://www.busybox.net/downloads/legacy/busybox-0.60.5.tar.gz
