...
# last mod WmT, 2009-03-02	[ (c) and GPLv2 1999-2009 ]
...
BUSYBOX_PKGNAME:=busybox-${BUSYBOX_VER}
...
${TOPLEV}/${BUSYBOX_PKGNAME}.egp: ${BUSYBOX_INSTTEMP}/bin/busybox
	${PCREATE_SCRIPT} create ${TOPLEV}/${BUSYBOX_PKGNAME}.egp ${BUSYBOX_INSTTEMP}

${XDC_ROOT}/bin/busybox: ${TOPLEV}/${BUSYBOX_PKGNAME}.egp
	mkdir -p ${XDC_ROOT}
	${PCREATE_SCRIPT} install ${XDC_ROOT} ${TOPLEV}/${BUSYBOX_PKGNAME}.egp

REALCLEAN_TARGETS+= ${TOPLEV}/${BUSYBOX_PKGNAME}.egp
...
xdc-busybox: ${TOPLEV}/${BUSYBOX_PKGNAME}.egp
endif
