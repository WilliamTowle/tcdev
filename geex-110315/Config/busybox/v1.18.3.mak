# busybox 1.18.3		[ since 0.60.5, c.2006-06-17 ]
...
${EXTTEMP}/${BUSYBOX_PATH}-xdc/busybox: ${EXTTEMP}/${BUSYBOX_PATH}-xdc/Makefile
	( cd ${EXTTEMP}/${BUSYBOX_PATH}-xdc || exit 1 ;\
		...
		1.1.0|1.2.2.1) \
			make VERBOSE=y \
		;; \
		1.4.[012]|1.5.[01]|1.6.0|1.7.[02]|1.8.[012]|1.9.[012]|1.10.[01234]|1.11.[123]|1.12.1|1.13.[1234]|1.14.[0124]|1.15.[23]|1.16.2|1.17.[01234]|1.18.[023]) \
