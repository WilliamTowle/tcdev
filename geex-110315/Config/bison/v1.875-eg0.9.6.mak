...
URLS+=http://www.mirrorservice.org/sites/ftp.gnu.org/pub/gnu/bison/bison-${BISON_VER}.tar.bz2
...
# could install-exec-recursive, but 'bash' needs /TC/usr/share content
