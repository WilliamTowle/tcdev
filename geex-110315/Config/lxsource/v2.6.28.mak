# linux source 2.6.28		[ since 2.0.37pre10 ]
...
URLS+=http://www.mirrorservice.org/sites/ftp.kernel.org/pub/linux/kernel/v2.6/linux-${LXSOURCE_VER}.tar.bz2
...
LXSOURCE_ARCH_OPTS+= CROSS_COMPILE=${XTC_ROOT}/usr/bin/${LXHEADERS_TARGET_SPEC}-
