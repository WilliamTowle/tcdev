...
include Config/bison/v2.4.1.mak
include Config/busybox/v1.14.4-maof0.8.1-3.mak
...
include Config/host-binutils/v2.17-lch0.9.6-3.mak
include Config/host-gcc/v4.1.2-lch0.9.6.mak
include Config/kgcc/v4.1.2-lch0.9.4.mak
include Config/lxheaders/v2.6.20.1-lch0.9.6.mak
...
# uClibc 0.9.28.3 with patches (to Gentoo-1.9) doesn't cross-compile
include Config/uClibc-dev/v0.9.28.3-lch0.9.6-3.mak
include Config/uClibc-rt/v0.9.28.3-lch0.9.6.mak
