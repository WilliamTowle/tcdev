# uClibc-dev 0.9.29		[ since 0.9.20 ]
# last mod WmT, 11/07/2007	[ (c) and GPLv2 1999-2007 ]
...
#URLS+=http://uclibc.org/downloads/old-releases/uClibc-0.9.22.tar.bz2
...
${EXTTEMP}/${UCLIBC_DEV_PATH}/.configured:
	...
	mkdir -p ${ETCDIR}
	[ -s ${ETCDIR}/uClibc-${UCLIBC_DEV_VER}-config ] \
	|| ( cd ${ETCDIR}/ || exit 1 ;\
		( \
		...
		*)	\
		...
		) >> uClibc-${UCLIBC_DEV_VER}-config || exit 1 \
	  )
	( cd ${EXTTEMP}/${UCLIBC_DEV_PATH} || exit 1 ;\
		cp ${ETCDIR}/uClibc-${UCLIBC_DEV_VER}-config .config || exit 1 ;\
	...
	touch ${EXTTEMP}/${UCLIBC_DEV_PATH}/.configured
...
${EXTTEMP}/uClibc-dev-${UCLIBC_DEV_VER}-xtc/libc/libc.a:
	${MAKE} ${EXTTEMP}/${UCLIBC_DEV_PATH}/.configured
	[ ! -d ${EXTTEMP}/uClibc-dev-${UCLIBC_DEV_VER}-xtc ] || rm -rf ${EXTTEMP}/uClibc-dev-${UCLIBC_DEV_VER}-xtc
	mv ${EXTTEMP}/${UCLIBC_DEV_PATH} ${EXTTEMP}/uClibc-dev-${UCLIBC_DEV_VER}-xtc
...
${EXTTEMP}/uClibc-dev-${UCLIBC_DEV_VER}-xdc/libc/libc.a:
	...
	mv ${EXTTEMP}/${UCLIBC_DEV_PATH} ${EXTTEMP}/uClibc-dev-${UCLIBC_DEV_VER}-xdc
