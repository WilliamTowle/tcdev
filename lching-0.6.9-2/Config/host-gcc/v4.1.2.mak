# gcc 4.1.2
# last mod WmT, 03/04/2006	[ (c) and GPLv2 1999-2007 ]
...
URLS+= http://www.mirrorservice.org/sites/ftp.gnu.org/gnu/gcc/gcc-4.1.2/gcc-core-4.1.2.tar.bz2
...
${EXTTEMP}/${HOST_GCC_PATH}-xdc/host-${NATIVE_SPEC}/libiberty/libiberty.a: ${EXTTEMP}/${HOST_GCC_PATH}-xdc/Makefile
	( cd ${EXTTEMP}/${HOST_GCC_PATH}-xdc || exit 1 ;\
...
${XDC_INSTTEMP}/usr/bin/gcc:
	${MAKE} ${EXTTEMP}/${HOST_GCC_PATH}-xdc/host-${NATIVE_SPEC}/libiberty/libiberty.a
	( cd ${EXTTEMP}/${HOST_GCC_PATH}-xdc || exit 1 ;\
