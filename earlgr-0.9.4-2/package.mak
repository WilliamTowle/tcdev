...
include Config/busybox/v0.60.5-eg0.9.3-2.mak
include Config/bzip2/v1.0.4-eg0.9.3.mak
include Config/coreutils/v5.97-eg0.9.3.mak
#include Config/cross-binutils/v2.17-ban0.9.2.mak
...
#include Config/host-binutils/v2.17-eg0.9.3.mak
...
include Config/lxheaders/v2.0.40-eg0.9.3.mak
...
#include Config/uClibc-dev/v0.9.20-eg0.9.4.mak
include Config/uClibc-dev/v0.9.20-eg0.9.4-2.mak
#include Config/uClibc-rt/v0.9.20-eg0.9.4.mak
include Config/uClibc-rt/v0.9.20-eg0.9.4-2.mak
include Config/util-linux/v2.12r.mak
