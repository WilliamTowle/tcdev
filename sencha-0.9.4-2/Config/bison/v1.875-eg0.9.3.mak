...
#URLS+=http://www.mirror.ac.uk/mirror/ftp.gnu.org/gnu/bison/bison-${BISON_VER}.tar.gz
URLS+=http://www.mirrorservice.org/sites/ftp.gnu.org/pub/gnu/bison/bison-1.875.tar.bz2
...
${EXTTEMP}/${BISON_PATH}-htc/Makefile:
	...
	touch ${EXTTEMP}/${BISON_PATH}-htc/.configured
...
${EXTTEMP}/${BISON_PATH}-htc/src/bison: ${EXTTEMP}/${BISON_PATH}-htc/Makefile
	...
	touch ${EXTTEMP}/${BISON_PATH}-htc/.built
