...
# binutils/gcc 2.95.3 need ___brk_addr in uClibc
# ...sadly ___brk_addr is obsoleted in uClibc >= 0.9.27

# busybox 1.1.0 bb_xasprintf() broken with uClibc 0.9.20 :(

# import package targets
include Config/bash/v3.2pl5-eg0.9.3.mak
include Config/bison/v1.875-eg0.9.6-2.mak
include Config/busybox/v1.1.0-sen0.9.6-2.mak
...
include Config/host-binutils/v2.16.1-eg0.9.6-3.mak
include Config/host-gcc/v2.95.3-2-eg0.9.6-3.mak
include Config/kgcc/v2.95.3-2-eg0.9.5-2.mak
include Config/lxheaders/v2.4.34.1-ban0.9.6.mak
...
include Config/sed/v4.1.5-sb0.9.6.mak
ifeq (${MF_HAVE_ISOFS},y)
include Config/syslinux/v3.84.mak
endif
include Config/tar/v1.13-eg0.9.6.mak
include Config/uClibc-dev/v0.9.26-sen0.9.6.mak
include Config/uClibc-rt/v0.9.26-sen0.9.6.mak
