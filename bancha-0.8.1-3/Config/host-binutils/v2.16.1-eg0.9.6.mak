...
# last mod WmT, 2009-01-20	[ (c) and GPLv2 1999-2009 ]
...
#X	HOST_BINUTILS_SRC+=${TOPLEV}/gb-patches/binutils/patches/10_uclibc-conf.diff
#X	HOST_BINUTILS_SRC+=${TOPLEV}/gb-patches/binutils/patches/20_uclibc-libtool-conf.diff
#X	else
...
HOST_BINUTILS_SRC+=${SOURCEROOT}/b/binutils-2.19-patches-1.1.tar.bz2
